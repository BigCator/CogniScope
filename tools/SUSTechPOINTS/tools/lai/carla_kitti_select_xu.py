...
label_path = 'F:/carla数据备份/rain1_3_4_7_6_8/label/'
calibFile = 'F:/carla数据备份/rain1_3_4_7_6_8/calib/front.json'
sourceImagePath = 'F:/carla数据备份/rain1_3_4_7_6_8/image/'
sourceVelodynePath = 'F:/carla数据备份/rain1_3_4_7_6_8/velodyne/'

kittiLabelPath = 'F:/data_carla/vod_carla_1219/lidar/training/label_2/'
kittiCalibPath = 'F:/data_carla/vod_carla_1219/lidar/training/calib/'
imageSetsPath = 'F:/data_carla/vod_carla_1219/lidar/ImageSets/'
trainingPath = 'F:/data_carla/vod_carla_1219/lidar/training/'
testingPath = 'F:/data_carla/vod_carla_1219/lidar/testing/'
...
for i, fname in enumerate(train_indices):
    ...
    # 复制图像和点云
    img_src = os.path.join(sourceImagePath, fname.replace("json", "jpg"))
    img_dst = os.path.join(trainingPath, 'image_2', fname.replace("json", "jpg"))
...
for i, fname in enumerate(test_indices):
    ...
    # 复制图像和点云
    img_src = os.path.join(sourceImagePath, fname.replace("json", "jpg"))
    img_dst = os.path.join(testingPath, 'image_2', fname.replace("json", "jpg"))
    pc_src = os.path.join(sourceVelodynePath, fname.replace("json", "bin"))
