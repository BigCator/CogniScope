...
train_pipeline = [
    dict(
        type='LoadPointsFromDict',      # ✅ 改成从字典加载
        keys=['lidar_points'],
        coord_type='LIDAR',
        load_dim=3,
        use_dim=[0, 1, 2]
    ...
    dict(
        type='Pack3DDetInputs',
        keys=['lidar_points', 'img', 'gt_bboxes_3d', 'gt_labels_3d', 'gt_bboxes', 'gt_labels']
    )
]
...
test_pipeline = [
    ...
    dict(type='Pack3DDetInputs', keys=['points', 'img'])  # ✅ 改成 lidar_points
]
