...
class TrackingNode(Node):
    def __init__(self):
        ...
        # 换小模型做检测
        det_config = '/home/local/zdtest/track_ws/src/masa_track/masa_track/projects/mmdet_configs/yolox/yolox_s_8xb8-300e_coco.py'
        det_checkpoint = '/home/local/zdtest/track_ws/src/masa_track/masa_track/saved_models/pretrain_weights/yolox_s_8x8_300e_coco_20211121_095711-4592a793.pth'
