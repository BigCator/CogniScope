...
class KittiDataset(DatasetTemplate):
    ...
    def get_attach_radar(self, idx):
        ...
        # ====================carla dataset===========================#
        used_feature_list = self.dataset_cfg.get('ATTACH_USED_FEATURE_LIST',['x', 'y', 'z', 'vr', 'v_r_compensated', 'distance'])
        ...
        # ====================carla dataset===========================#
        idx = [0, 1, 2]
        if 'vr' in used_feature_list:
            idx += [3]
        if 'v_r_compensated' in used_feature_list:
            idx += [4]
        if 'distance' in used_feature_list:
            idx += [5]
        idx = np.array(idx)
        # =============================================================#
    ...
    def get_radar(self, idx):
        ...
        # radar_point_cloud[:, 0] += 1
        # radar_point_cloud[:, 2] -= 1.1
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        # 新增 ROI_WIDE
        vod_evaluation_result.update(
            vod_eval.get_official_eval_result(eval_gt_annos, eval_det_annos, class_names, custom_method=4,
                                              is_radar=self.is_radar))
