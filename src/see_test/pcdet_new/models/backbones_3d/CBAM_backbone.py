...
from ...ops.pointnet2.pointnet2_batch import pointnet2_CBAM
import os


class CBAM_Backbone(nn.Module):
    """ Backbone for IA-SSD"""
        ...
        for k in range(sa_config.NSAMPLE_LIST.__len__()):
            ...
            if self.layer_types[k] == 'SA_Layer':
                ...
                self.SA_modules.append(
                    pointnet2_CBAM.PointnetSAModuleMSG_CBAM(
                ...
                self.SA_modules.append(pointnet2_CBAM.Vote_layer(mlp_list=sa_config.MLPS[k],
                ...
                try:
                    ...
                    pass
                self.SA_modules.append(
                    pointnet2_CBAM.AttentiveSAModule(
