...
def log_kitti_result(eval_results, logger, ret_dict):
    ...
    ret_dict['mAP_3d_kitti'] = (kitti_evaluation_result['entire_area']['Car_3d_all'] +
                                kitti_evaluation_result['entire_area']['Pedestrian_3d_all'] +
                                kitti_evaluation_result['entire_area']['Cyclist_3d_all']) / 3
...
def log_vod_result(eval_results, logger, ret_dict):  # ！！！！！！！！！！！！！！！！！！
    ...
    logger.info("Results: \n"
                ...
                f"mAP: {(vod_evaluation_result['entire_area']['Car_3d_all'] + vod_evaluation_result['entire_area']['Pedestrian_3d_all']) / 2} \n"
                ...
                f"mAP: {(vod_evaluation_result['roi']['Car_3d_all'] + vod_evaluation_result['roi']['Pedestrian_3d_all']) / 2} \n"
                )
    # 新增 ROI_WIDE 打印（如存在）
    if 'roi_wide' in vod_evaluation_result:
        logger.info("Driving corridor WIDE area: \n"
                    f"Car: {vod_evaluation_result['roi_wide']['Car_3d_all']} \n"
                    f"Pedestrian: {vod_evaluation_result['roi_wide']['Pedestrian_3d_all']} \n"
                    f"mAP: {(vod_evaluation_result['roi_wide']['Car_3d_all'] + vod_evaluation_result['roi_wide']['Pedestrian_3d_all']) / 2} \n")
    ...
    current_epoch_mAP_3d = (vod_evaluation_result['entire_area']['Car_3d_all'] + vod_evaluation_result['entire_area']['Pedestrian_3d_all']) / 2
    ...
    ret_dict['mAP_3d_vod'] = (vod_evaluation_result['entire_area']['Car_3d_all'] + vod_evaluation_result['entire_area']['Pedestrian_3d_all']) / 2
...
def log_inhouse_result(eval_results, logger, ret_dict):
    ...
    current_epoch_mAP_3d = (vod_evaluation_result['entire_area']['Car_3d_all'] + vod_evaluation_result['entire_area'][
        'Pedestrian_3d_all'] + vod_evaluation_result['entire_area']['Cyclist_3d_all']) / 3
    ret_dict['mAP_3d'] = current_epoch_mAP_3d

    ret_dict['mAP_3d_vod'] = (vod_evaluation_result['entire_area']['Car_3d_all'] + vod_evaluation_result['entire_area'][
        'Pedestrian_3d_all'] + vod_evaluation_result['entire_area']['Cyclist_3d_all']) / 3
    return current_epoch_mAP_3d
