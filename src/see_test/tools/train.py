...
def parse_config():
    ...
    parser.add_argument('--extra_tag', type=str, default='carla_initial_debug', help='extra tag for this experiment')
...
def main():
    ...
    # 创建一个 TensorBoard 日志记录器，用于将训练过程中的指标（如损失、精度等）记录到 TensorBoard 中，方便后续可视化
