...
# ===== 导入 pcdet =====
import sys
sys.path.append("/workspace/ros2_yolo/src/see_test/pcdet")
...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='/CenterPoint-KITTI/tools/cfgs/kitti_models/IA-SSD-GAN-aug-lidar.yaml', help='specify the config for training')
    ...
    parser.add_argument('--extra_tag', type=str, default='carla_initial', help='extra tag for this experiment')
    parser.add_argument('--ckpt', type=str, default='/CenterPoint-KITTI/ckpts/cfar-lidar.pt', help='checkpoint to start from')
    parser.add_argument('--pretrained_model', type=str, default='/CenterPoint-KITTI/ckpts/cfar-lidar.pt', help='pretrained_model')
...
def main():
    ...
    if args.fix_random_seed:
        common_utils.set_random_seed(100)
