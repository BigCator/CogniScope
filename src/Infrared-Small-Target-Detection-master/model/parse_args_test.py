...
def parse_args():
    ...
    parser.add_argument('--st_model', type=str, default='NUDT-SIRST_DNANet_18_05_2023_11_13_32_wDS',
                        help='NUDT-SIRST_DNANet_31_07_2021_14_50_57_wDS,'
                             'NUAA-SIRST_DNANet_28_07_2021_05_21_33_wDS')
    parser.add_argument('--model_dir', type=str,
                        default = 'NUDT-SIRST_DNANet_18_05_2023_11_13_32_wDS/mIoU__DNANet_NUDT-SIRST_epoch.pth.tar',
    ...
    #  hyper params for visulization
    parser.add_argument('--save_dir', type=str, default='./val', help='')
