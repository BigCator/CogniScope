...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov5_l.pth', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/dft/cnn_swin_buchang_TwoEncoding_FLIR_aligned.yaml', help='model.yaml path')
    ...
    parser.add_argument('--resume', nargs='?', const=True, default='runs/train/exp19/weights/last.pt', help='resume most recent training')
    ...
    parser.add_argument('--device', default='2,5', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
