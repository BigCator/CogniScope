...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/yolov5l_swin_fusion_transformerx3_llvip_0.9674/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='/workspace/CogniScope/src/multispectral-object-detection-main/data/rgb_image', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/workspace/CogniScope/src/multispectral-object-detection-main/data/ir_image', help='source')  # file/folder, 0 for webcam
