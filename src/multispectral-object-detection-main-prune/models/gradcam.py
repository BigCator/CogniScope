...
class YOLOV5GradCAM:
    ...
    def forward(self, input_rgb_img, input_ir_img, class_idx=True):
        """
        Args:
        ...
        """
        saliency_maps = []
        b, c, h, w = input_rgb_img.size()
        preds, logits = self.model(input_rgb_img, input_ir_img)
    ...
    def __call__(self, input_rgb_img, input_ir_img):
        return self.forward(input_rgb_img, input_ir_img)
