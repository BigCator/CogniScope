...
class SystemState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('ptpData')) {
        this.ptpData = initObj.ptpData
      }
      else {
        this.ptpData = new SystemStatePtpData();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [ptpData]
    bufferOffset = SystemStatePtpData.serialize(obj.ptpData, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [ptpData]
    data.ptpData = SystemStatePtpData.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.ptpData !== undefined) {
      resolved.ptpData = SystemStatePtpData.Resolve(msg.ptpData)
    }
    else {
      resolved.ptpData = new SystemStatePtpData()
    }
