...
;//! \htmlinclude SystemStateWoPtp.msg.html

(cl:defclass <SystemStateWoPtp> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass SystemStateWoPtp (<SystemStateWoPtp>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SystemStateWoPtp>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SystemStateWoPtp)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name radar_msgs-msg:<SystemStateWoPtp> is deprecated: use radar_msgs-msg:SystemStateWoPtp instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <SystemStateWoPtp>))
...
(cl:defmethod temp-val ((m <SystemStateWoPtp>))
...
(cl:defmethod voltage-val ((m <SystemStateWoPtp>))
...
(cl:defmethod freq-val ((m <SystemStateWoPtp>))
...
(cl:defmethod load-val ((m <SystemStateWoPtp>))
...
(cl:defmethod primaryHeap-val ((m <SystemStateWoPtp>))
...
(cl:defmethod heapArr-val ((m <SystemStateWoPtp>))
  ...
  (heapArr m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SystemStateWoPtp>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SystemStateWoPtp>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SystemStateWoPtp>)))
  "Returns string type for a message object of type '<SystemStateWoPtp>"
  "radar_msgs/SystemStateWoPtp")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SystemStateWoPtp)))
  "Returns string type for a message object of type 'SystemStateWoPtp"
  "radar_msgs/SystemStateWoPtp")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SystemStateWoPtp>)))
  "Returns md5sum for a message object of type '<SystemStateWoPtp>"
  "d2347aeac5c0a8642643083e21097b3a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SystemStateWoPtp)))
  "Returns md5sum for a message object of type 'SystemStateWoPtp"
  "d2347aeac5c0a8642643083e21097b3a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SystemStateWoPtp>)))
  "Returns full string definition for message of type '<SystemStateWoPtp>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SystemStateWoPtp)))
  "Returns full string definition for message of type 'SystemStateWoPtp"
  (cl:format cl:nil "Header                      header  # Includes measurement timestamp and coordinate frame.~%SystemStateTemp[5]          temp~%float32[5]                  voltage~%uint32[10]                  freq~%SystemStatsLoad[10]         load~%SystemStatsheap[4]          primaryHeap~%SystemStatsheapArr[9]       heapArr~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: radar_msgs/SystemStateTemp~%# Header header               # Includes measurement timestamp and coordinate frame.~%float32       minTemp~%float32       maxTemp~%================================================================================~%MSG: radar_msgs/SystemStatsLoad~%# Header header               # Includes measurement timestamp and coordinate frame.~%# uint32      integerValue~%# uint32      fractionalValue~%float32     loadValue~%================================================================================~%MSG: radar_msgs/SystemStatsheap~%# Header header               # Includes measurement timestamp and coordinate frame.~%uint32       heapSize~%uint32       freeSize~%================================================================================~%MSG: radar_msgs/SystemStatsheapArr~%# Header header           # Includes measurement timestamp and coordinate frame.~%SystemStatsheap[2]     heap~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SystemStateWoPtp>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SystemStateWoPtp>))
  "Converts a ROS message object to a list"
  (cl:list 'SystemStateWoPtp
