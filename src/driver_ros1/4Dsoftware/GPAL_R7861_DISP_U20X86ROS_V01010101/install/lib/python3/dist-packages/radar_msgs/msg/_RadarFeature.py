...
"""autogenerated by genpy from radar_msgs/RadarFeature.msg. Do not edit."""
import codecs
import sys
...
class RadarFeature(genpy.Message):
  _md5sum = "f7ad55b5738dc6964897be14d4580716"
  _type = "radar_msgs/RadarFeature"
...
string frame_id
"""
  __slots__ = ['header','targetNum','d','v','azimuth']
  _slot_types = ['std_msgs/Header','uint32','float32[]','float32[]','float32[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.targetNum,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
