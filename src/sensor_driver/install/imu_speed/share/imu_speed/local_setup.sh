...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_yolo/src/sensor_driver/install/imu_speed"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imu_speed/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imu_speed/environment/path.sh"
