...
#include "common_unique_msgs/msg/detail/custom_gnss__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const common_unique_msgs::msg::CustomGNSS & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  common_unique_msgs::msg::CustomGNSS & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_common_unique_msgs
max_serialized_size_CustomGNSS(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = common_unique_msgs::msg::CustomGNSS;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const common_unique_msgs::msg::CustomGNSS *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<common_unique_msgs::msg::CustomGNSS *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CustomGNSS__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const common_unique_msgs::msg::CustomGNSS *>(
...
static size_t _CustomGNSS__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CustomGNSS(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CustomGNSS__callbacks = {
...
static rosidl_message_type_support_t _CustomGNSS__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CustomGNSS__callbacks,
...
{
  return &common_unique_msgs::msg::typesupport_fastrtps_cpp::_CustomGNSS__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, common_unique_msgs, msg, CustomGNSS)() {
  return &common_unique_msgs::msg::typesupport_fastrtps_cpp::_CustomGNSS__handle;
}
