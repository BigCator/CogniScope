...
#include "common_unique_msgs/msg/detail/uni_header__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const common_unique_msgs::msg::UniHeader & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  common_unique_msgs::msg::UniHeader & ros_message)
{
  // Member: ui_msg_id
  cdr >> ros_message.ui_msg_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = common_unique_msgs::msg::UniHeader;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const common_unique_msgs::msg::UniHeader *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<common_unique_msgs::msg::UniHeader *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UniHeader__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const common_unique_msgs::msg::UniHeader *>(
...
static size_t _UniHeader__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UniHeader(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UniHeader__callbacks = {
...
static rosidl_message_type_support_t _UniHeader__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UniHeader__callbacks,
...
{
  return &common_unique_msgs::msg::typesupport_fastrtps_cpp::_UniHeader__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, common_unique_msgs, msg, UniHeader)() {
  return &common_unique_msgs::msg::typesupport_fastrtps_cpp::_UniHeader__handle;
}
